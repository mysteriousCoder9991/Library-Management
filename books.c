...
{
    char rgenre[51];
    printf("Enter the required genre ");
    gets(rgenre);
    int i;
    printf("The books of the required genre is : \n");
    for(i=0;i<=uid;i++)
        if(strcmp(rgenre,no[uid].genre)==0)
            {
            printf("\nUID:- %d",no[i].UID);
            printf("\nBook name :- ");
            puts(no[i].bname);
...
void partiAuhtorDisp()
{
    char raname[51];
    printf("Enter the required Author's Name ");
    gets(raname);
    int i;
    printf("The books of the required author/s is : \n");
    for(i=0;i<=uid;i++)
        if(strcmp(raname,no[i].aname)==0)
            {
            printf("\nUID:- %d",no[i].UID);
            printf("\nBook name :- ");
            puts(no[i].bname);
...
void partiPublishDisp()
{
    char rpname[151];
    printf("Enter the required Publisher's Name ");
    gets(rpname);
    int i;
    printf("The books of the required publisher is : \n");
    for(i=0;i<=uid;i++)
        if(strcmp(rpname,no[i].pname)==0)
            {
            printf("\nUID:- %d",no[i].UID);
            printf("\nBook name :- ");
            puts(no[i].bname);
